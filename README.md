...
- **`christmas.html`** — the ordering system. Open a counter, then open a
  product to see its weights or stuffing choices. Tapping one adds it and
  gives you a **− 1 +** quantity stepper. Add your details, pick a
  collection day, and go through to the confirmation.
...
item gets a plain **Add to order** button instead.
